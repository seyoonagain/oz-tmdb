...
const InfiniteScrollMovies = ({ setPage, movieList, lastPage }) => {
  ...
  return (
    <>
      <section className='max-w-screen-3xl place-items-center grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-10 px-10'>
        {movieList &&
